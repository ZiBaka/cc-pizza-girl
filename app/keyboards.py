...
def create_keyboard_according_date_type(date_type: str, selected_year_for_day: str = None
                                        , selected_month_for_day: str = None):
    ...
    match date_type:
        ...
        case 'day':
            return create_day_keyboard(int(selected_year_for_day), int(selected_month_for_day))
        case 'hour':
